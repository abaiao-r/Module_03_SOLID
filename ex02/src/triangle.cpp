...
Triangle::Triangle(double side1, double side2, double side3, double height) : _side1(side1), _side2(side2), _side3(side3), _height(height)
{
}

Triangle::Triangle(Triangle const &src) : _side1(src._side1), _side2(src._side2), _side3(src._side3), _height(src._height)
{
}
